...
(function () {
  ...
  var PHRASES = {
    ...
    "BP, battles, death and permanent progress": ["BP, 전투, 패배, 영구 성장", "BP、バトル、敗北、永続進行", "BP、战斗、失败与永久成长", "BP、戰鬥、失敗與永久成長", "BP, Kämpfe, Niederlagen und permanenter Fortschritt", "BP, combats, défaite et progression permanente", "BP, combates, derrota y progreso permanente", "BP, batalhas, derrota e progresso permanente", "BP, бои, поражение и постоянный прогресс", "BP, pertempuran, kekalahan, dan progres permanen"],
