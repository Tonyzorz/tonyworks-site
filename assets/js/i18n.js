...
(function () {
  ...
  function addArticleNotice() {
    ...
    if (["portal", "home", "monsters", "bosses", "items", "sets", "maps", "characters", "achievements", "guide", "design-notes", "game-data", "faq", "patch", "about", "contact", "privacy", "terms", "deletion"].indexOf(page) === -1 || document.querySelector(".translation-notice")) return;
